...
export type ResignationManagementRecord = {
  ...
  resignationCertificateApplication?: ResignationCertificateApplication;
};

export type ResignationCertificate = {
  templateId: string;
  templateName: string;
  fileName: string;
  sealApplicationNo?: string;
  generatedAt: string;
};

export type ResignationCertificateApplicationStatus = "用印申请中" | "已通过" | "已驳回" | "已撤回";

export type ResignationCertificateApplication = {
  templateId: string;
  templateName: string;
  fileName: string;
  status: ResignationCertificateApplicationStatus;
  sealApplicationNo: string;
  appliedAt: string;
  endedAt?: string;
};

export type ResignationCertificateTemplate = {
  id: string;
  name: string;
  fileName: string;
...
export const resignationCertificatePlaceholderLabels: Record<string, string> = {
  employeeName: "员工姓名",
  employeeNo: "员工编号",
  department: "部门",
  position: "岗位",
...
export const resignationCertificateDefaultPlaceholders: Record<string, string> = {
  employeeName: "张三",
  employeeNo: "LS0000",
  department: "运营中心",
  position: "运营专员",
  ...
  companyName: "成都拉森科技有限公司",
  issueDate: "2026-05-13",
};

export const resignationCertificateTemplates: ResignationCertificateTemplate[] = [
  {
    id: "RCT-1",
    name: "标准离职证明模板",
    fileName: "标准离职证明模板.docx",
    placeholderDefaults: resignationCertificateDefaultPlaceholders,
    updatedAt: "2026-05-01 10:00",
  },
  {
    id: "RCT-2",
    name: "英文离职证明模板",
    fileName: "英文离职证明模板.docx",
    placeholderDefaults: {
      ...resignationCertificateDefaultPlaceholders,
      companyName: "Chengdu Larsen Technology Co., Ltd.",
    },
...
export const resignationManagementRecords: ResignationManagementRecord[] = [
  ...
  },
  {
    ...
    resignationCertificate: {
      templateId: "RCT-2",
      templateName: "英文离职证明模板",
      fileName: "陈嘉-离职证明.docx",
      sealApplicationNo: "SEAL-202605-021",
      generatedAt: "2026-05-04 17:20",
    },
    resignationCertificateApplication: {
      templateId: "RCT-1",
      templateName: "标准离职证明模板",
      fileName: "陈嘉-离职证明-重新生成.docx",
      status: "用印申请中",
      sealApplicationNo: "SEAL-202605-029",
      appliedAt: "2026-05-05 10:30",
    },
  },
  {
    id: "RM-5",
    ...
    rank: "P2",
    hireDate: "2023-09-18",
    resignationDate: "2026-05-28",
    status: "已确认",
    approvalStatus: "已通过",
    resignationType: "主动离职",
    resignationReasons: ["职业规划"],
    reasonDescription: "审批通过后 HR 已确认离职。",
    phone: "13800010027",
    responsibleHr: "林珊",
    updater: "林珊",
    updatedAt: "2026-05-06 09:20",
    submitTime: "2026-05-01 09:12",
    applicationVersion: "V1",
    riskResults: [
      { role: "所属部门", conclusion: "无风险", handledAt: "2026-05-01 11:10" },
      { role: "行政部", conclusion: "无风险", handledAt: "2026-05-01 11:35" },
      { role: "人力资源部", conclusion: "无风险", handledAt: "2026-05-01 12:05" },
      { role: "财务部", conclusion: "无风险", handledAt: "2026-05-01 12:28" },
    ],
    resignationCertificateApplication: {
      templateId: "RCT-1",
      templateName: "标准离职证明模板",
      ...
      status: "用印申请中",
      sealApplicationNo: "SEAL-202605-033",
      appliedAt: "2026-05-06 09:30",
    },
  },
  {
    id: "RM-6",
    ...
    approvalStatus: "已通过",
    resignationType: "主动离职",
    resignationReasons: ["家庭原因"],
    reasonDescription: "离职证明重新生成申请被驳回，保留上一次文件。",
    phone: "13800010031",
    responsibleHr: "何敏",
    updater: "何敏",
    updatedAt: "2026-05-06 10:10",
    submitTime: "2026-05-02 09:40",
    applicationVersion: "V1",
    riskResults: [
      { role: "所属部门", conclusion: "无风险", handledAt: "2026-05-02 13:10" },
      { role: "行政部", conclusion: "无风险", handledAt: "2026-05-02 13:35" },
      { role: "人力资源部", conclusion: "无风险", handledAt: "2026-05-02 14:05" },
      { role: "财务部", conclusion: "无风险", handledAt: "2026-05-02 14:28" },
    ],
    resignationCertificate: {
      templateId: "RCT-1",
      templateName: "标准离职证明模板",
      fileName: "周然-离职证明.docx",
      sealApplicationNo: "SEAL-202605-036",
      generatedAt: "2026-05-06 11:10",
    },
    resignationCertificateApplication: {
      templateId: "RCT-2",
      templateName: "英文离职证明模板",
      fileName: "周然-离职证明-英文.docx",
      status: "已驳回",
      sealApplicationNo: "SEAL-202605-039",
      appliedAt: "2026-05-06 14:30",
      endedAt: "2026-05-06 16:10",
    },
  },
];
