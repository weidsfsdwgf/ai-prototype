...
import { FileTemplateManagementPage } from "../pages/FileTemplateManagementPage";
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "oa/hr/file-templates", element: <FileTemplateManagementPage /> },
      { path: "oa/hr/performance", element: <Navigate to="/oa/performance/records" replace /> },
      ...
      { path: "oa/config/scorecards", element: <Navigate to="/oa/performance/scorecards" replace /> },
